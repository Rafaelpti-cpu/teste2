...
>
> **What is not ruled out.** That the deployment carrying the fix never landed —
> the build status is only visible in the Vercel dashboard, and nothing in the
> commit is user-visible enough to fingerprint from outside. Check that first.
>
