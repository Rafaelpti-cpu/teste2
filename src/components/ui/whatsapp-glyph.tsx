...
/**
 * The WhatsApp mark, as a filled path that takes `currentColor`.
 *
 * Decorative in every current use — the surrounding control carries the label
 * or an `aria-label` — so it is always `aria-hidden`. Sizing is the caller's
 * job; this only draws.
 */
